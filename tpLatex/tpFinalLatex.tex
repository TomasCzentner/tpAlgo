...
\begin{problema}{cerrarSalasDeLaCadena}{cs: [Cine], e: \ent}{}{}
	\requiere {e \ge 0}
	\modifica {cs}
	\asegura [mismosCines]{long(cs) == long(pre(cs)}
...
\begin{problema}{ingresarASala}{c: Cine, s: Sala, t: Ticket}{}
	...
	\asegura[mismosTickets]{mismos(ticketsVendidosSinUsar(c), \comp{ti}{ti \selec ticketsVendidosSinUsar(pre(c)),\newline ti \neq t})}
\end{problema}
...
\aux{mismoNombre}{c: Cine, c`: Cine}{\bool}{nombre(c) == nombre(c`)}
